{
  ...
  '#':: d.pkg(name='imageStreamLayers', url='', help='"ImageStreamLayers describes information about the layers referenced by images in this image stream."'),
  ...
  '#new':: d.fn(help='new returns an instance of ImageStreamLayers', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'image.openshift.io/v1',
    kind: 'ImageStreamLayers',
  } + self.metadata.withName(name=name),
  '#withBlobs':: d.fn(help='"blobs is a map of blob name to metadata about the blob."', args=[d.arg(name='blobs', type=d.T.object)]),
  withBlobs(blobs): { blobs: blobs },
  '#withBlobsMixin':: d.fn(help='"blobs is a map of blob name to metadata about the blob."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='blobs', type=d.T.object)]),
  withBlobsMixin(blobs): { blobs+: blobs },
  '#withImages':: d.fn(help='"images is a map between an image name and the names of the blobs and config that comprise the image."', args=[d.arg(name='images', type=d.T.object)]),
  withImages(images): { images: images },
  '#withImagesMixin':: d.fn(help='"images is a map between an image name and the names of the blobs and config that comprise the image."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='images', type=d.T.object)]),
  withImagesMixin(images): { images+: images },
  '#mixin': 'ignore',
  mixin: self,
}
