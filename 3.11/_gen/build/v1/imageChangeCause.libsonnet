{
  ...
  '#':: d.pkg(name='imageChangeCause', url='', help='"ImageChangeCause contains information about the image that triggered a build"'),
  ...
  fromRef: {
    ...
    withApiVersion(apiVersion): { fromRef+: { apiVersion: apiVersion } },
    ...
    withFieldPath(fieldPath): { fromRef+: { fieldPath: fieldPath } },
    ...
    withKind(kind): { fromRef+: { kind: kind } },
    '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
    withName(name): { fromRef+: { name: name } },
    ...
    withNamespace(namespace): { fromRef+: { namespace: namespace } },
    ...
    withResourceVersion(resourceVersion): { fromRef+: { resourceVersion: resourceVersion } },
