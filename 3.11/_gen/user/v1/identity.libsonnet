{
  ...
  '#':: d.pkg(name='identity', url='', help='"Identity records a successful authentication of a user with an identity provider. The information about the source of authentication is stored on the identity, and the identity is then associated with a single user object. Multiple identities can reference a single user. Information retrieved from the authentication provider is stored in the extra field using a schema determined by the provider."'),
  ...
  '#new':: d.fn(help='new returns an instance of Identity', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'user.openshift.io/v1',
    kind: 'Identity',
  } + self.metadata.withName(name=name),
  '#user':: d.obj(help='"ObjectReference contains enough information to let you inspect or modify the referred object."'),
  user: {
    '#withApiVersion':: d.fn(help='"API version of the referent."', args=[d.arg(name='apiVersion', type=d.T.string)]),
    withApiVersion(apiVersion): { user+: { apiVersion: apiVersion } },
    ...
    withFieldPath(fieldPath): { user+: { fieldPath: fieldPath } },
    ...
    withNamespace(namespace): { user+: { namespace: namespace } },
    ...
    withResourceVersion(resourceVersion): { user+: { resourceVersion: resourceVersion } },
  ...
  '#withExtra':: d.fn(help='"Extra holds extra information about this identity"', args=[d.arg(name='extra', type=d.T.object)]),
  withExtra(extra): { extra: extra },
  '#withExtraMixin':: d.fn(help='"Extra holds extra information about this identity"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='extra', type=d.T.object)]),
  withExtraMixin(extra): { extra+: extra },
  '#withProviderName':: d.fn(help='"ProviderName is the source of identity information"', args=[d.arg(name='providerName', type=d.T.string)]),
  withProviderName(providerName): { providerName: providerName },
  '#withProviderUserName':: d.fn(help='"ProviderUserName uniquely represents this identity in the scope of the provider"', args=[d.arg(name='providerUserName', type=d.T.string)]),
  withProviderUserName(providerUserName): { providerUserName: providerUserName },
  '#mixin': 'ignore',
  mixin: self,
}
