---
permalink: /3.11/oauth/v1/oAuthAccessToken/
---

# oauth.v1.oAuthAccessToken
...
* [`fn new(name)`](#fn-new)
* [`fn withAuthorizeToken(authorizeToken)`](#fn-withauthorizetoken)
* [`fn withClientName(clientName)`](#fn-withclientname)
* [`fn withExpiresIn(expiresIn)`](#fn-withexpiresin)
* [`fn withInactivityTimeoutSeconds(inactivityTimeoutSeconds)`](#fn-withinactivitytimeoutseconds)
* [`fn withRedirectURI(redirectURI)`](#fn-withredirecturi)
* [`fn withRefreshToken(refreshToken)`](#fn-withrefreshtoken)
* [`fn withScopes(scopes)`](#fn-withscopes)
* [`fn withScopesMixin(scopes)`](#fn-withscopesmixin)
* [`fn withUserName(userName)`](#fn-withusername)
* [`fn withUserUID(userUID)`](#fn-withuseruid)
...
new returns an instance of OAuthAccessToken

### fn withAuthorizeToken

```ts
withAuthorizeToken(authorizeToken)
```
...
### fn withInactivityTimeoutSeconds

```ts
withInactivityTimeoutSeconds(inactivityTimeoutSeconds)
```
