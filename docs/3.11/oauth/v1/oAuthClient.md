---
permalink: /3.11/oauth/v1/oAuthClient/
---

# oauth.v1.oAuthClient
...
* [`fn new(name)`](#fn-new)
* [`fn withAccessTokenInactivityTimeoutSeconds(accessTokenInactivityTimeoutSeconds)`](#fn-withaccesstokeninactivitytimeoutseconds)
* [`fn withAccessTokenMaxAgeSeconds(accessTokenMaxAgeSeconds)`](#fn-withaccesstokenmaxageseconds)
* [`fn withAdditionalSecrets(additionalSecrets)`](#fn-withadditionalsecrets)
* [`fn withAdditionalSecretsMixin(additionalSecrets)`](#fn-withadditionalsecretsmixin)
* [`fn withGrantMethod(grantMethod)`](#fn-withgrantmethod)
* [`fn withRedirectURIs(redirectURIs)`](#fn-withredirecturis)
* [`fn withRedirectURIsMixin(redirectURIs)`](#fn-withredirecturismixin)
* [`fn withRespondWithChallenges(respondWithChallenges)`](#fn-withrespondwithchallenges)
* [`fn withScopeRestrictions(scopeRestrictions)`](#fn-withscoperestrictions)
* [`fn withScopeRestrictionsMixin(scopeRestrictions)`](#fn-withscoperestrictionsmixin)
...
new returns an instance of OAuthClient

### fn withAccessTokenInactivityTimeoutSeconds

```ts
withAccessTokenInactivityTimeoutSeconds(accessTokenInactivityTimeoutSeconds)
```
...
### fn withAccessTokenMaxAgeSeconds

```ts
withAccessTokenMaxAgeSeconds(accessTokenMaxAgeSeconds)
```
...
### fn withAdditionalSecrets

```ts
withAdditionalSecrets(additionalSecrets)
```
...
### fn withAdditionalSecretsMixin

```ts
withAdditionalSecretsMixin(additionalSecrets)
```
...
### fn withRespondWithChallenges

```ts
withRespondWithChallenges(respondWithChallenges)
```

"RespondWithChallenges indicates whether the client wants authentication needed responses made in the form of challenges instead of redirects"

### fn withScopeRestrictions

```ts
withScopeRestrictions(scopeRestrictions)
```
...
### fn withScopeRestrictionsMixin

```ts
withScopeRestrictionsMixin(scopeRestrictions)
```
