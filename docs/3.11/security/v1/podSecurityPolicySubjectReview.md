---
permalink: /3.11/security/v1/podSecurityPolicySubjectReview/
---

# security.v1.podSecurityPolicySubjectReview
...
new returns an instance of PodSecurityPolicySubjectReview
