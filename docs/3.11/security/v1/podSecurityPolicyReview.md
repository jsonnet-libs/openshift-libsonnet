---
permalink: /3.11/security/v1/podSecurityPolicyReview/
---

# security.v1.podSecurityPolicyReview
...
* [`fn new(name)`](#fn-new)
* [`obj spec`](#obj-spec)
  * [`fn withServiceAccountNames(serviceAccountNames)`](#fn-specwithserviceaccountnames)
  * [`fn withServiceAccountNamesMixin(serviceAccountNames)`](#fn-specwithserviceaccountnamesmixin)
...
new returns an instance of PodSecurityPolicyReview

## obj spec

"PodSecurityPolicyReviewSpec defines specification for PodSecurityPolicyReview"

### fn spec.withServiceAccountNames

```ts
withServiceAccountNames(serviceAccountNames)
```
...
### fn spec.withServiceAccountNamesMixin

```ts
withServiceAccountNamesMixin(serviceAccountNames)
```
