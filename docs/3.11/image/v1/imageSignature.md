---
permalink: /3.11/image/v1/imageSignature/
---

# image.v1.imageSignature
...
* [`fn withImageIdentity(imageIdentity)`](#fn-withimageidentity)
* [`fn withSignedClaims(signedClaims)`](#fn-withsignedclaims)
* [`fn withSignedClaimsMixin(signedClaims)`](#fn-withsignedclaimsmixin)
* [`fn withType(type)`](#fn-withtype)
* [`obj issuedBy`](#obj-issuedby)
  * [`fn withCommonName(commonName)`](#fn-issuedbywithcommonname)
  * [`fn withOrganization(organization)`](#fn-issuedbywithorganization)
* [`obj issuedTo`](#obj-issuedto)
  * [`fn withCommonName(commonName)`](#fn-issuedtowithcommonname)
  * [`fn withOrganization(organization)`](#fn-issuedtowithorganization)
  * [`fn withPublicKeyID(publicKeyID)`](#fn-issuedtowithpublickeyid)
...
new returns an instance of ImageSignature
...
### fn withImageIdentity

```ts
withImageIdentity(imageIdentity)
```
...
```ts
withSignedClaims(signedClaims)
```

"Contains claims from the signature."

### fn withSignedClaimsMixin

```ts
withSignedClaimsMixin(signedClaims)
```
