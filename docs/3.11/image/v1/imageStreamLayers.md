---
permalink: /3.11/image/v1/imageStreamLayers/
---

# image.v1.imageStreamLayers
...
* [`fn new(name)`](#fn-new)
* [`fn withBlobs(blobs)`](#fn-withblobs)
* [`fn withBlobsMixin(blobs)`](#fn-withblobsmixin)
...
new returns an instance of ImageStreamLayers
