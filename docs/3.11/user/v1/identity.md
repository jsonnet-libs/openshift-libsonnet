---
permalink: /3.11/user/v1/identity/
---
...
* [`fn withProviderUserName(providerUserName)`](#fn-withproviderusername)
...
new returns an instance of Identity
...
### fn withProviderUserName

```ts
withProviderUserName(providerUserName)
```
