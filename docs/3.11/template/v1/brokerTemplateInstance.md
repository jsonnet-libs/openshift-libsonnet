---
permalink: /3.11/template/v1/brokerTemplateInstance/
---

# template.v1.brokerTemplateInstance
...
* [`obj spec`](#obj-spec)
  * [`fn withBindingIDs(bindingIDs)`](#fn-specwithbindingids)
  * [`fn withBindingIDsMixin(bindingIDs)`](#fn-specwithbindingidsmixin)
  * [`obj spec.secret`](#obj-specsecret)
    * [`fn withApiVersion(apiVersion)`](#fn-specsecretwithapiversion)
    * [`fn withFieldPath(fieldPath)`](#fn-specsecretwithfieldpath)
    * [`fn withKind(kind)`](#fn-specsecretwithkind)
    * [`fn withName(name)`](#fn-specsecretwithname)
    * [`fn withNamespace(namespace)`](#fn-specsecretwithnamespace)
    * [`fn withResourceVersion(resourceVersion)`](#fn-specsecretwithresourceversion)
    * [`fn withUid(uid)`](#fn-specsecretwithuid)
  * [`obj spec.templateInstance`](#obj-spectemplateinstance)
    * [`fn withApiVersion(apiVersion)`](#fn-spectemplateinstancewithapiversion)
    * [`fn withFieldPath(fieldPath)`](#fn-spectemplateinstancewithfieldpath)
    * [`fn withKind(kind)`](#fn-spectemplateinstancewithkind)
    * [`fn withName(name)`](#fn-spectemplateinstancewithname)
    * [`fn withNamespace(namespace)`](#fn-spectemplateinstancewithnamespace)
    * [`fn withResourceVersion(resourceVersion)`](#fn-spectemplateinstancewithresourceversion)
    * [`fn withUid(uid)`](#fn-spectemplateinstancewithuid)
...
new returns an instance of BrokerTemplateInstance
...
### fn spec.secret.withResourceVersion
...
## obj spec.templateInstance

"ObjectReference contains enough information to let you inspect or modify the referred object."

### fn spec.templateInstance.withApiVersion
...
### fn spec.templateInstance.withFieldPath
...
### fn spec.templateInstance.withKind
...
### fn spec.templateInstance.withName
...
### fn spec.templateInstance.withNamespace
...
### fn spec.templateInstance.withResourceVersion
...
### fn spec.templateInstance.withUid
