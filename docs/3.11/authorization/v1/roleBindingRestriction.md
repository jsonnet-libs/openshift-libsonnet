---
permalink: /3.11/authorization/v1/roleBindingRestriction/
---

# authorization.v1.roleBindingRestriction
...
* [`obj spec`](#obj-spec)
  * [`obj spec.grouprestriction`](#obj-specgrouprestriction)
    * [`fn withGroups(groups)`](#fn-specgrouprestrictionwithgroups)
    * [`fn withGroupsMixin(groups)`](#fn-specgrouprestrictionwithgroupsmixin)
    * [`fn withLabels(labels)`](#fn-specgrouprestrictionwithlabels)
    * [`fn withLabelsMixin(labels)`](#fn-specgrouprestrictionwithlabelsmixin)
  * [`obj spec.serviceaccountrestriction`](#obj-specserviceaccountrestriction)
    * [`fn withNamespaces(namespaces)`](#fn-specserviceaccountrestrictionwithnamespaces)
    * [`fn withNamespacesMixin(namespaces)`](#fn-specserviceaccountrestrictionwithnamespacesmixin)
    * [`fn withServiceaccounts(serviceaccounts)`](#fn-specserviceaccountrestrictionwithserviceaccounts)
    * [`fn withServiceaccountsMixin(serviceaccounts)`](#fn-specserviceaccountrestrictionwithserviceaccountsmixin)
  * [`obj spec.userrestriction`](#obj-specuserrestriction)
    * [`fn withGroups(groups)`](#fn-specuserrestrictionwithgroups)
    * [`fn withGroupsMixin(groups)`](#fn-specuserrestrictionwithgroupsmixin)
    * [`fn withLabels(labels)`](#fn-specuserrestrictionwithlabels)
    * [`fn withLabelsMixin(labels)`](#fn-specuserrestrictionwithlabelsmixin)
    * [`fn withUsers(users)`](#fn-specuserrestrictionwithusers)
    * [`fn withUsersMixin(users)`](#fn-specuserrestrictionwithusersmixin)
...
new returns an instance of RoleBindingRestriction
...
### fn spec.grouprestriction.withGroupsMixin
...
### fn spec.grouprestriction.withLabels
...
### fn spec.grouprestriction.withLabelsMixin
...
## obj spec.serviceaccountrestriction
...
### fn spec.serviceaccountrestriction.withNamespaces
...
### fn spec.serviceaccountrestriction.withNamespacesMixin
...
### fn spec.serviceaccountrestriction.withServiceaccounts
...
### fn spec.serviceaccountrestriction.withServiceaccountsMixin
...
### fn spec.userrestriction.withGroups
...
### fn spec.userrestriction.withGroupsMixin
...
### fn spec.userrestriction.withLabels
...
### fn spec.userrestriction.withLabelsMixin
...
### fn spec.userrestriction.withUsers
...
### fn spec.userrestriction.withUsersMixin
