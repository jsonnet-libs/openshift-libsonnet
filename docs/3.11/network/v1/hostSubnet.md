---
permalink: /3.11/network/v1/hostSubnet/
---

# network.v1.hostSubnet
...
* [`fn new(name)`](#fn-new)
* [`fn withEgressCIDRs(egressCIDRs)`](#fn-withegresscidrs)
* [`fn withEgressCIDRsMixin(egressCIDRs)`](#fn-withegresscidrsmixin)
...
* [`fn withSubnet(subnet)`](#fn-withsubnet)
...
new returns an instance of HostSubnet

### fn withEgressCIDRs

```ts
withEgressCIDRs(egressCIDRs)
```
...
### fn withEgressCIDRsMixin

```ts
withEgressCIDRsMixin(egressCIDRs)
```
