---
permalink: /3.11/network/v1/clusterNetwork/
---

# network.v1.clusterNetwork
...
* [`fn new(name)`](#fn-new)
* [`fn withClusterNetworks(clusterNetworks)`](#fn-withclusternetworks)
* [`fn withClusterNetworksMixin(clusterNetworks)`](#fn-withclusternetworksmixin)
* [`fn withHostsubnetlength(hostsubnetlength)`](#fn-withhostsubnetlength)
* [`fn withNetwork(network)`](#fn-withnetwork)
* [`fn withPluginName(pluginName)`](#fn-withpluginname)
* [`fn withServiceNetwork(serviceNetwork)`](#fn-withservicenetwork)
* [`fn withVxlanPort(vxlanPort)`](#fn-withvxlanport)
...
new returns an instance of ClusterNetwork

### fn withClusterNetworks

```ts
withClusterNetworks(clusterNetworks)
```
...
### fn withClusterNetworksMixin

```ts
withClusterNetworksMixin(clusterNetworks)
```
