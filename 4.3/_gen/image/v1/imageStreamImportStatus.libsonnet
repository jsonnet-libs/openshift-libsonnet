{
  ...
  '#':: d.pkg(name='imageStreamImportStatus', url='', help='"ImageStreamImportStatus contains information about the status of an image stream import."'),
  '#import':: d.obj(help='"ImageStream stores a mapping of tags to images, metadata overrides that are applied when images are tagged in a stream, and an optional reference to a container image repository on a registry."'),
  'import': {
    ...
    metadata: {
      ...
      initializers: {
        ...
        result: {
          ...
          details: {
            ...
            withCauses(causes): { 'import'+: { metadata+: { initializers+: { result+: { details+: { causes: if std.isArray(v=causes) then causes else [causes] } } } } } },
            ...
            withCausesMixin(causes): { 'import'+: { metadata+: { initializers+: { result+: { details+: { causes+: if std.isArray(v=causes) then causes else [causes] } } } } } },
            ...
            withGroup(group): { 'import'+: { metadata+: { initializers+: { result+: { details+: { group: group } } } } } },
            ...
            withKind(kind): { 'import'+: { metadata+: { initializers+: { result+: { details+: { kind: kind } } } } } },
            ...
            withName(name): { 'import'+: { metadata+: { initializers+: { result+: { details+: { name: name } } } } } },
            ...
            withRetryAfterSeconds(retryAfterSeconds): { 'import'+: { metadata+: { initializers+: { result+: { details+: { retryAfterSeconds: retryAfterSeconds } } } } } },
            ...
            withUid(uid): { 'import'+: { metadata+: { initializers+: { result+: { details+: { uid: uid } } } } } },
          },
          ...
          withApiVersion(apiVersion): { 'import'+: { metadata+: { initializers+: { result+: { apiVersion: apiVersion } } } } },
          '#withCode':: d.fn(help='"Suggested HTTP return code for this status, 0 if not set."', args=[d.arg(name='code', type=d.T.integer)]),
          withCode(code): { 'import'+: { metadata+: { initializers+: { result+: { code: code } } } } },
          ...
          withKind(kind): { 'import'+: { metadata+: { initializers+: { result+: { kind: kind } } } } },
          ...
          withMessage(message): { 'import'+: { metadata+: { initializers+: { result+: { message: message } } } } },
          ...
          withMetadata(metadata): { 'import'+: { metadata+: { initializers+: { result+: { metadata: metadata } } } } },
          ...
          withReason(reason): { 'import'+: { metadata+: { initializers+: { result+: { reason: reason } } } } },
          ...
          withStatus(status): { 'import'+: { metadata+: { initializers+: { result+: { status: status } } } } },
        },
        ...
        withPending(pending): { 'import'+: { metadata+: { initializers+: { pending: if std.isArray(v=pending) then pending else [pending] } } } },
        ...
        withPendingMixin(pending): { 'import'+: { metadata+: { initializers+: { pending+: if std.isArray(v=pending) then pending else [pending] } } } },
      },
      '#withAnnotations':: d.fn(help='"Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: http://kubernetes.io/docs/user-guide/annotations"', args=[d.arg(name='annotations', type=d.T.object)]),
      withAnnotations(annotations): { 'import'+: { metadata+: { annotations: annotations } } },
      '#withAnnotationsMixin':: d.fn(help='"Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: http://kubernetes.io/docs/user-guide/annotations"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
      withAnnotationsMixin(annotations): { 'import'+: { metadata+: { annotations+: annotations } } },
      '#withClusterName':: d.fn(help='"The name of the cluster which the object belongs to. This is used to distinguish resources with same name and namespace in different clusters. This field is not set anywhere right now and apiserver is going to ignore it if set in create or update request."', args=[d.arg(name='clusterName', type=d.T.string)]),
      withClusterName(clusterName): { 'import'+: { metadata+: { clusterName: clusterName } } },
      '#withCreationTimestamp':: d.fn(help='', args=[d.arg(name='creationTimestamp', type=d.T.string)]),
      withCreationTimestamp(creationTimestamp): { 'import'+: { metadata+: { creationTimestamp: creationTimestamp } } },
      '#withDeletionGracePeriodSeconds':: d.fn(help='"Number of seconds allowed for this object to gracefully terminate before it will be removed from the system. Only set when deletionTimestamp is also set. May only be shortened. Read-only."', args=[d.arg(name='deletionGracePeriodSeconds', type=d.T.integer)]),
      withDeletionGracePeriodSeconds(deletionGracePeriodSeconds): { 'import'+: { metadata+: { deletionGracePeriodSeconds: deletionGracePeriodSeconds } } },
      '#withDeletionTimestamp':: d.fn(help='', args=[d.arg(name='deletionTimestamp', type=d.T.string)]),
      withDeletionTimestamp(deletionTimestamp): { 'import'+: { metadata+: { deletionTimestamp: deletionTimestamp } } },
      ...
      withFinalizers(finalizers): { 'import'+: { metadata+: { finalizers: if std.isArray(v=finalizers) then finalizers else [finalizers] } } },
      ...
      withFinalizersMixin(finalizers): { 'import'+: { metadata+: { finalizers+: if std.isArray(v=finalizers) then finalizers else [finalizers] } } },
      ...
      withGenerateName(generateName): { 'import'+: { metadata+: { generateName: generateName } } },
      '#withGeneration':: d.fn(help='"A sequence number representing a specific generation of the desired state. Populated by the system. Read-only."', args=[d.arg(name='generation', type=d.T.integer)]),
      withGeneration(generation): { 'import'+: { metadata+: { generation: generation } } },
      '#withLabels':: d.fn(help='"Map of string keys and values that can be used to organize and categorize (scope and select) objects. May match selectors of replication controllers and services. More info: http://kubernetes.io/docs/user-guide/labels"', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { 'import'+: { metadata+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='"Map of string keys and values that can be used to organize and categorize (scope and select) objects. May match selectors of replication controllers and services. More info: http://kubernetes.io/docs/user-guide/labels"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { 'import'+: { metadata+: { labels+: labels } } },
      '#withName':: d.fn(help='"Name must be unique within a namespace. Is required when creating resources, although some resources may allow a client to request the generation of an appropriate name automatically. Name is primarily intended for creation idempotence and configuration definition. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/identifiers#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { 'import'+: { metadata+: { name: name } } },
      ...
      withNamespace(namespace): { 'import'+: { metadata+: { namespace: namespace } } },
      '#withOwnerReferences':: d.fn(help='"List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller."', args=[d.arg(name='ownerReferences', type=d.T.array)]),
      withOwnerReferences(ownerReferences): { 'import'+: { metadata+: { ownerReferences: if std.isArray(v=ownerReferences) then ownerReferences else [ownerReferences] } } },
      '#withOwnerReferencesMixin':: d.fn(help='"List of objects depended by this object. If ALL objects in the list have been deleted, this object will be garbage collected. If this object is managed by a controller, then an entry in this list will point to this controller, with the controller field set to true. There cannot be more than one managing controller."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ownerReferences', type=d.T.array)]),
      withOwnerReferencesMixin(ownerReferences): { 'import'+: { metadata+: { ownerReferences+: if std.isArray(v=ownerReferences) then ownerReferences else [ownerReferences] } } },
      ...
      withResourceVersion(resourceVersion): { 'import'+: { metadata+: { resourceVersion: resourceVersion } } },
      ...
      withSelfLink(selfLink): { 'import'+: { metadata+: { selfLink: selfLink } } },
      '#withUid':: d.fn(help='"UID is the unique in time and space value for this object. It is typically generated by the server on successful creation of a resource and is not allowed to change on PUT operations.\\n\\nPopulated by the system. Read-only. More info: http://kubernetes.io/docs/user-guide/identifiers#uids"', args=[d.arg(name='uid', type=d.T.string)]),
      withUid(uid): { 'import'+: { metadata+: { uid: uid } } },
    },
    ...
    spec: {
      ...
      lookupPolicy: {
        ...
        withLocal(Local): { 'import'+: { spec+: { lookupPolicy+: { 'local': Local } } } },
      },
      ...
      withDockerImageRepository(dockerImageRepository): { 'import'+: { spec+: { dockerImageRepository: dockerImageRepository } } },
      '#withTags':: d.fn(help='"tags map arbitrary string values to specific image locators"', args=[d.arg(name='tags', type=d.T.array)]),
      withTags(tags): { 'import'+: { spec+: { tags: if std.isArray(v=tags) then tags else [tags] } } },
      ...
      withTagsMixin(tags): { 'import'+: { spec+: { tags+: if std.isArray(v=tags) then tags else [tags] } } },
    },
    '#status':: d.obj(help='"ImageStreamStatus contains information about the state of this image stream."'),
    status: {
      ...
      withDockerImageRepository(dockerImageRepository): { 'import'+: { status+: { dockerImageRepository: dockerImageRepository } } },
      ...
      withPublicDockerImageRepository(publicDockerImageRepository): { 'import'+: { status+: { publicDockerImageRepository: publicDockerImageRepository } } },
      ...
      withTags(tags): { 'import'+: { status+: { tags: if std.isArray(v=tags) then tags else [tags] } } },
      ...
      withTagsMixin(tags): { 'import'+: { status+: { tags+: if std.isArray(v=tags) then tags else [tags] } } },
    },
    '#withApiVersion':: d.fn(help='"APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#resources"', args=[d.arg(name='apiVersion', type=d.T.string)]),
    withApiVersion(apiVersion): { 'import'+: { apiVersion: apiVersion } },
    '#withKind':: d.fn(help='"Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds"', args=[d.arg(name='kind', type=d.T.string)]),
    withKind(kind): { 'import'+: { kind: kind } },
  },
  '#repository':: d.obj(help='"RepositoryImportStatus describes the result of an image repository import"'),
  repository: {
    '#status':: d.obj(help="\"Status is a return value for calls that don't return other objects.\""),
    status: {
      '#details':: d.obj(help='"StatusDetails is a set of additional properties that MAY be set by the server to provide additional information about a response. The Reason field of a Status object defines what attributes will be set. Clients must ignore fields that do not match the defined type of each attribute, and should assume that any attribute may be empty, invalid, or under defined."'),
      details: {
        '#withCauses':: d.fn(help='"The Causes array includes more details associated with the StatusReason failure. Not all StatusReasons may provide detailed causes."', args=[d.arg(name='causes', type=d.T.array)]),
        withCauses(causes): { repository+: { status+: { details+: { causes: if std.isArray(v=causes) then causes else [causes] } } } },
        '#withCausesMixin':: d.fn(help='"The Causes array includes more details associated with the StatusReason failure. Not all StatusReasons may provide detailed causes."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='causes', type=d.T.array)]),
        withCausesMixin(causes): { repository+: { status+: { details+: { causes+: if std.isArray(v=causes) then causes else [causes] } } } },
        '#withGroup':: d.fn(help='"The group attribute of the resource associated with the status StatusReason."', args=[d.arg(name='group', type=d.T.string)]),
        withGroup(group): { repository+: { status+: { details+: { group: group } } } },
        '#withKind':: d.fn(help='"The kind attribute of the resource associated with the status StatusReason. On some operations may differ from the requested resource Kind. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds"', args=[d.arg(name='kind', type=d.T.string)]),
        withKind(kind): { repository+: { status+: { details+: { kind: kind } } } },
        '#withName':: d.fn(help='"The name attribute of the resource associated with the status StatusReason (when there is a single name which can be described)."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { repository+: { status+: { details+: { name: name } } } },
        '#withRetryAfterSeconds':: d.fn(help='"If specified, the time in seconds before the operation should be retried. Some errors may indicate the client must take an alternate action - for those errors this field may indicate how long to wait before taking the alternate action."', args=[d.arg(name='retryAfterSeconds', type=d.T.integer)]),
        withRetryAfterSeconds(retryAfterSeconds): { repository+: { status+: { details+: { retryAfterSeconds: retryAfterSeconds } } } },
        '#withUid':: d.fn(help='"UID of the resource. (when there is a single resource which can be described). More info: http://kubernetes.io/docs/user-guide/identifiers#uids"', args=[d.arg(name='uid', type=d.T.string)]),
        withUid(uid): { repository+: { status+: { details+: { uid: uid } } } },
      },
      '#withApiVersion':: d.fn(help='"APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#resources"', args=[d.arg(name='apiVersion', type=d.T.string)]),
      withApiVersion(apiVersion): { repository+: { status+: { apiVersion: apiVersion } } },
      '#withCode':: d.fn(help='"Suggested HTTP return code for this status, 0 if not set."', args=[d.arg(name='code', type=d.T.integer)]),
      withCode(code): { repository+: { status+: { code: code } } },
      '#withKind':: d.fn(help='"Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds"', args=[d.arg(name='kind', type=d.T.string)]),
      withKind(kind): { repository+: { status+: { kind: kind } } },
      '#withMessage':: d.fn(help='"A human-readable description of the status of this operation."', args=[d.arg(name='message', type=d.T.string)]),
      withMessage(message): { repository+: { status+: { message: message } } },
      '#withMetadata':: d.fn(help='"Standard list metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds"', args=[d.arg(name='metadata', type=d.T.any)]),
      withMetadata(metadata): { repository+: { status+: { metadata: metadata } } },
      '#withReason':: d.fn(help='"A machine-readable description of why this operation is in the \\"Failure\\" status. If this value is empty there is no information available. A Reason clarifies an HTTP status code but does not override it."', args=[d.arg(name='reason', type=d.T.string)]),
      withReason(reason): { repository+: { status+: { reason: reason } } },
      '#withStatus':: d.fn(help='"Status of the operation. One of: \\"Success\\" or \\"Failure\\". More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status"', args=[d.arg(name='status', type=d.T.string)]),
      withStatus(status): { repository+: { status+: { status: status } } },
    },
    ...
    withAdditionalTags(additionalTags): { repository+: { additionalTags: if std.isArray(v=additionalTags) then additionalTags else [additionalTags] } },
    ...
    withAdditionalTagsMixin(additionalTags): { repository+: { additionalTags+: if std.isArray(v=additionalTags) then additionalTags else [additionalTags] } },
    ...
    withImages(images): { repository+: { images: if std.isArray(v=images) then images else [images] } },
    ...
    withImagesMixin(images): { repository+: { images+: if std.isArray(v=images) then images else [images] } },
  },
  '#withImages':: d.fn(help='"Images is set with the result of importing spec.images"', args=[d.arg(name='images', type=d.T.array)]),
  withImages(images): { images: if std.isArray(v=images) then images else [images] },
  '#withImagesMixin':: d.fn(help='"Images is set with the result of importing spec.images"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='images', type=d.T.array)]),
