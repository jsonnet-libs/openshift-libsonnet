{
  ...
  '#':: d.pkg(name='rollingDeploymentStrategyParams', url='', help='"RollingDeploymentStrategyParams are the input to the Rolling deployment strategy."'),
  ...
  withUpdatePeriodSeconds(updatePeriodSeconds): { updatePeriodSeconds: updatePeriodSeconds },
  '#mixin': 'ignore',
  mixin: self,
}
