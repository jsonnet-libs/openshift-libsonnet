{
  ...
  '#spec':: d.obj(help='"DeploymentConfigSpec represents the desired state of the deployment."'),
  spec: {
    ...
    strategy: {
      ...
      customParams: {
        ...
        withCommand(command): { spec+: { strategy+: { customParams+: { command: if std.isArray(v=command) then command else [command] } } } },
        ...
        withCommandMixin(command): { spec+: { strategy+: { customParams+: { command+: if std.isArray(v=command) then command else [command] } } } },
        ...
        withEnvironment(environment): { spec+: { strategy+: { customParams+: { environment: if std.isArray(v=environment) then environment else [environment] } } } },
        ...
        withEnvironmentMixin(environment): { spec+: { strategy+: { customParams+: { environment+: if std.isArray(v=environment) then environment else [environment] } } } },
        ...
        withImage(image): { spec+: { strategy+: { customParams+: { image: image } } } },
      },
      ...
      recreateParams: {
        ...
        mid: {
          ...
          execNewPod: {
            ...
            withCommand(command): { spec+: { strategy+: { recreateParams+: { mid+: { execNewPod+: { command: if std.isArray(v=command) then command else [command] } } } } } },
            '#withCommandMixin':: d.fn(help='"Command is the action command and its arguments."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='command', type=d.T.array)]),
            withCommandMixin(command): { spec+: { strategy+: { recreateParams+: { mid+: { execNewPod+: { command+: if std.isArray(v=command) then command else [command] } } } } } },
            ...
            withContainerName(containerName): { spec+: { strategy+: { recreateParams+: { mid+: { execNewPod+: { containerName: containerName } } } } } },
            ...
            withEnv(env): { spec+: { strategy+: { recreateParams+: { mid+: { execNewPod+: { env: if std.isArray(v=env) then env else [env] } } } } } },
            ...
            withEnvMixin(env): { spec+: { strategy+: { recreateParams+: { mid+: { execNewPod+: { env+: if std.isArray(v=env) then env else [env] } } } } } },
            ...
            withVolumes(volumes): { spec+: { strategy+: { recreateParams+: { mid+: { execNewPod+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } } } } } },
            ...
            withVolumesMixin(volumes): { spec+: { strategy+: { recreateParams+: { mid+: { execNewPod+: { volumes+: if std.isArray(v=volumes) then volumes else [volumes] } } } } } },
          },
          ...
          withFailurePolicy(failurePolicy): { spec+: { strategy+: { recreateParams+: { mid+: { failurePolicy: failurePolicy } } } } },
          ...
          withTagImages(tagImages): { spec+: { strategy+: { recreateParams+: { mid+: { tagImages: if std.isArray(v=tagImages) then tagImages else [tagImages] } } } } },
          ...
          withTagImagesMixin(tagImages): { spec+: { strategy+: { recreateParams+: { mid+: { tagImages+: if std.isArray(v=tagImages) then tagImages else [tagImages] } } } } },
        },
        ...
        post: {
          ...
          execNewPod: {
            '#withCommand':: d.fn(help='"Command is the action command and its arguments."', args=[d.arg(name='command', type=d.T.array)]),
            withCommand(command): { spec+: { strategy+: { recreateParams+: { post+: { execNewPod+: { command: if std.isArray(v=command) then command else [command] } } } } } },
            '#withCommandMixin':: d.fn(help='"Command is the action command and its arguments."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='command', type=d.T.array)]),
            withCommandMixin(command): { spec+: { strategy+: { recreateParams+: { post+: { execNewPod+: { command+: if std.isArray(v=command) then command else [command] } } } } } },
            '#withContainerName':: d.fn(help="\"ContainerName is the name of a container in the deployment pod template whose container image will be used for the hook pod's container.\"", args=[d.arg(name='containerName', type=d.T.string)]),
            withContainerName(containerName): { spec+: { strategy+: { recreateParams+: { post+: { execNewPod+: { containerName: containerName } } } } } },
            '#withEnv':: d.fn(help="\"Env is a set of environment variables to supply to the hook pod's container.\"", args=[d.arg(name='env', type=d.T.array)]),
            withEnv(env): { spec+: { strategy+: { recreateParams+: { post+: { execNewPod+: { env: if std.isArray(v=env) then env else [env] } } } } } },
            '#withEnvMixin':: d.fn(help="\"Env is a set of environment variables to supply to the hook pod's container.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='env', type=d.T.array)]),
            withEnvMixin(env): { spec+: { strategy+: { recreateParams+: { post+: { execNewPod+: { env+: if std.isArray(v=env) then env else [env] } } } } } },
            '#withVolumes':: d.fn(help='"Volumes is a list of named volumes from the pod template which should be copied to the hook pod. Volumes names not found in pod spec are ignored. An empty list means no volumes will be copied."', args=[d.arg(name='volumes', type=d.T.array)]),
            withVolumes(volumes): { spec+: { strategy+: { recreateParams+: { post+: { execNewPod+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } } } } } },
            '#withVolumesMixin':: d.fn(help='"Volumes is a list of named volumes from the pod template which should be copied to the hook pod. Volumes names not found in pod spec are ignored. An empty list means no volumes will be copied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumes', type=d.T.array)]),
            withVolumesMixin(volumes): { spec+: { strategy+: { recreateParams+: { post+: { execNewPod+: { volumes+: if std.isArray(v=volumes) then volumes else [volumes] } } } } } },
          },
          '#withFailurePolicy':: d.fn(help='"FailurePolicy specifies what action to take if the hook fails."', args=[d.arg(name='failurePolicy', type=d.T.string)]),
          withFailurePolicy(failurePolicy): { spec+: { strategy+: { recreateParams+: { post+: { failurePolicy: failurePolicy } } } } },
          '#withTagImages':: d.fn(help='"TagImages instructs the deployer to tag the current image referenced under a container onto an image stream tag."', args=[d.arg(name='tagImages', type=d.T.array)]),
          withTagImages(tagImages): { spec+: { strategy+: { recreateParams+: { post+: { tagImages: if std.isArray(v=tagImages) then tagImages else [tagImages] } } } } },
          '#withTagImagesMixin':: d.fn(help='"TagImages instructs the deployer to tag the current image referenced under a container onto an image stream tag."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tagImages', type=d.T.array)]),
          withTagImagesMixin(tagImages): { spec+: { strategy+: { recreateParams+: { post+: { tagImages+: if std.isArray(v=tagImages) then tagImages else [tagImages] } } } } },
        },
        ...
        pre: {
          ...
          execNewPod: {
            '#withCommand':: d.fn(help='"Command is the action command and its arguments."', args=[d.arg(name='command', type=d.T.array)]),
            withCommand(command): { spec+: { strategy+: { recreateParams+: { pre+: { execNewPod+: { command: if std.isArray(v=command) then command else [command] } } } } } },
            '#withCommandMixin':: d.fn(help='"Command is the action command and its arguments."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='command', type=d.T.array)]),
            withCommandMixin(command): { spec+: { strategy+: { recreateParams+: { pre+: { execNewPod+: { command+: if std.isArray(v=command) then command else [command] } } } } } },
            '#withContainerName':: d.fn(help="\"ContainerName is the name of a container in the deployment pod template whose container image will be used for the hook pod's container.\"", args=[d.arg(name='containerName', type=d.T.string)]),
            withContainerName(containerName): { spec+: { strategy+: { recreateParams+: { pre+: { execNewPod+: { containerName: containerName } } } } } },
            '#withEnv':: d.fn(help="\"Env is a set of environment variables to supply to the hook pod's container.\"", args=[d.arg(name='env', type=d.T.array)]),
            withEnv(env): { spec+: { strategy+: { recreateParams+: { pre+: { execNewPod+: { env: if std.isArray(v=env) then env else [env] } } } } } },
            '#withEnvMixin':: d.fn(help="\"Env is a set of environment variables to supply to the hook pod's container.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='env', type=d.T.array)]),
            withEnvMixin(env): { spec+: { strategy+: { recreateParams+: { pre+: { execNewPod+: { env+: if std.isArray(v=env) then env else [env] } } } } } },
            '#withVolumes':: d.fn(help='"Volumes is a list of named volumes from the pod template which should be copied to the hook pod. Volumes names not found in pod spec are ignored. An empty list means no volumes will be copied."', args=[d.arg(name='volumes', type=d.T.array)]),
            withVolumes(volumes): { spec+: { strategy+: { recreateParams+: { pre+: { execNewPod+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } } } } } },
            '#withVolumesMixin':: d.fn(help='"Volumes is a list of named volumes from the pod template which should be copied to the hook pod. Volumes names not found in pod spec are ignored. An empty list means no volumes will be copied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumes', type=d.T.array)]),
            withVolumesMixin(volumes): { spec+: { strategy+: { recreateParams+: { pre+: { execNewPod+: { volumes+: if std.isArray(v=volumes) then volumes else [volumes] } } } } } },
          },
          '#withFailurePolicy':: d.fn(help='"FailurePolicy specifies what action to take if the hook fails."', args=[d.arg(name='failurePolicy', type=d.T.string)]),
          withFailurePolicy(failurePolicy): { spec+: { strategy+: { recreateParams+: { pre+: { failurePolicy: failurePolicy } } } } },
          '#withTagImages':: d.fn(help='"TagImages instructs the deployer to tag the current image referenced under a container onto an image stream tag."', args=[d.arg(name='tagImages', type=d.T.array)]),
          withTagImages(tagImages): { spec+: { strategy+: { recreateParams+: { pre+: { tagImages: if std.isArray(v=tagImages) then tagImages else [tagImages] } } } } },
          '#withTagImagesMixin':: d.fn(help='"TagImages instructs the deployer to tag the current image referenced under a container onto an image stream tag."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tagImages', type=d.T.array)]),
          withTagImagesMixin(tagImages): { spec+: { strategy+: { recreateParams+: { pre+: { tagImages+: if std.isArray(v=tagImages) then tagImages else [tagImages] } } } } },
        },
        ...
        withTimeoutSeconds(timeoutSeconds): { spec+: { strategy+: { recreateParams+: { timeoutSeconds: timeoutSeconds } } } },
      },
      ...
      resources: {
        ...
        withLimits(limits): { spec+: { strategy+: { resources+: { limits: limits } } } },
        ...
        withLimitsMixin(limits): { spec+: { strategy+: { resources+: { limits+: limits } } } },
        ...
        withRequests(requests): { spec+: { strategy+: { resources+: { requests: requests } } } },
        ...
        withRequestsMixin(requests): { spec+: { strategy+: { resources+: { requests+: requests } } } },
      },
      ...
      rollingParams: {
        ...
        post: {
          ...
          execNewPod: {
            '#withCommand':: d.fn(help='"Command is the action command and its arguments."', args=[d.arg(name='command', type=d.T.array)]),
            withCommand(command): { spec+: { strategy+: { rollingParams+: { post+: { execNewPod+: { command: if std.isArray(v=command) then command else [command] } } } } } },
            '#withCommandMixin':: d.fn(help='"Command is the action command and its arguments."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='command', type=d.T.array)]),
            withCommandMixin(command): { spec+: { strategy+: { rollingParams+: { post+: { execNewPod+: { command+: if std.isArray(v=command) then command else [command] } } } } } },
            '#withContainerName':: d.fn(help="\"ContainerName is the name of a container in the deployment pod template whose container image will be used for the hook pod's container.\"", args=[d.arg(name='containerName', type=d.T.string)]),
            withContainerName(containerName): { spec+: { strategy+: { rollingParams+: { post+: { execNewPod+: { containerName: containerName } } } } } },
            '#withEnv':: d.fn(help="\"Env is a set of environment variables to supply to the hook pod's container.\"", args=[d.arg(name='env', type=d.T.array)]),
            withEnv(env): { spec+: { strategy+: { rollingParams+: { post+: { execNewPod+: { env: if std.isArray(v=env) then env else [env] } } } } } },
            '#withEnvMixin':: d.fn(help="\"Env is a set of environment variables to supply to the hook pod's container.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='env', type=d.T.array)]),
            withEnvMixin(env): { spec+: { strategy+: { rollingParams+: { post+: { execNewPod+: { env+: if std.isArray(v=env) then env else [env] } } } } } },
            '#withVolumes':: d.fn(help='"Volumes is a list of named volumes from the pod template which should be copied to the hook pod. Volumes names not found in pod spec are ignored. An empty list means no volumes will be copied."', args=[d.arg(name='volumes', type=d.T.array)]),
            withVolumes(volumes): { spec+: { strategy+: { rollingParams+: { post+: { execNewPod+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } } } } } },
            '#withVolumesMixin':: d.fn(help='"Volumes is a list of named volumes from the pod template which should be copied to the hook pod. Volumes names not found in pod spec are ignored. An empty list means no volumes will be copied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumes', type=d.T.array)]),
            withVolumesMixin(volumes): { spec+: { strategy+: { rollingParams+: { post+: { execNewPod+: { volumes+: if std.isArray(v=volumes) then volumes else [volumes] } } } } } },
          },
          '#withFailurePolicy':: d.fn(help='"FailurePolicy specifies what action to take if the hook fails."', args=[d.arg(name='failurePolicy', type=d.T.string)]),
          withFailurePolicy(failurePolicy): { spec+: { strategy+: { rollingParams+: { post+: { failurePolicy: failurePolicy } } } } },
          '#withTagImages':: d.fn(help='"TagImages instructs the deployer to tag the current image referenced under a container onto an image stream tag."', args=[d.arg(name='tagImages', type=d.T.array)]),
          withTagImages(tagImages): { spec+: { strategy+: { rollingParams+: { post+: { tagImages: if std.isArray(v=tagImages) then tagImages else [tagImages] } } } } },
          '#withTagImagesMixin':: d.fn(help='"TagImages instructs the deployer to tag the current image referenced under a container onto an image stream tag."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tagImages', type=d.T.array)]),
          withTagImagesMixin(tagImages): { spec+: { strategy+: { rollingParams+: { post+: { tagImages+: if std.isArray(v=tagImages) then tagImages else [tagImages] } } } } },
        },
        '#pre':: d.obj(help='"LifecycleHook defines a specific deployment lifecycle action. Only one type of action may be specified at any time."'),
        pre: {
          '#execNewPod':: d.obj(help='"ExecNewPodHook is a hook implementation which runs a command in a new pod based on the specified container which is assumed to be part of the deployment template."'),
          execNewPod: {
            '#withCommand':: d.fn(help='"Command is the action command and its arguments."', args=[d.arg(name='command', type=d.T.array)]),
            withCommand(command): { spec+: { strategy+: { rollingParams+: { pre+: { execNewPod+: { command: if std.isArray(v=command) then command else [command] } } } } } },
            '#withCommandMixin':: d.fn(help='"Command is the action command and its arguments."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='command', type=d.T.array)]),
            withCommandMixin(command): { spec+: { strategy+: { rollingParams+: { pre+: { execNewPod+: { command+: if std.isArray(v=command) then command else [command] } } } } } },
            '#withContainerName':: d.fn(help="\"ContainerName is the name of a container in the deployment pod template whose container image will be used for the hook pod's container.\"", args=[d.arg(name='containerName', type=d.T.string)]),
            withContainerName(containerName): { spec+: { strategy+: { rollingParams+: { pre+: { execNewPod+: { containerName: containerName } } } } } },
            '#withEnv':: d.fn(help="\"Env is a set of environment variables to supply to the hook pod's container.\"", args=[d.arg(name='env', type=d.T.array)]),
            withEnv(env): { spec+: { strategy+: { rollingParams+: { pre+: { execNewPod+: { env: if std.isArray(v=env) then env else [env] } } } } } },
            '#withEnvMixin':: d.fn(help="\"Env is a set of environment variables to supply to the hook pod's container.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='env', type=d.T.array)]),
            withEnvMixin(env): { spec+: { strategy+: { rollingParams+: { pre+: { execNewPod+: { env+: if std.isArray(v=env) then env else [env] } } } } } },
            '#withVolumes':: d.fn(help='"Volumes is a list of named volumes from the pod template which should be copied to the hook pod. Volumes names not found in pod spec are ignored. An empty list means no volumes will be copied."', args=[d.arg(name='volumes', type=d.T.array)]),
            withVolumes(volumes): { spec+: { strategy+: { rollingParams+: { pre+: { execNewPod+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } } } } } },
            '#withVolumesMixin':: d.fn(help='"Volumes is a list of named volumes from the pod template which should be copied to the hook pod. Volumes names not found in pod spec are ignored. An empty list means no volumes will be copied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='volumes', type=d.T.array)]),
            withVolumesMixin(volumes): { spec+: { strategy+: { rollingParams+: { pre+: { execNewPod+: { volumes+: if std.isArray(v=volumes) then volumes else [volumes] } } } } } },
          },
          '#withFailurePolicy':: d.fn(help='"FailurePolicy specifies what action to take if the hook fails."', args=[d.arg(name='failurePolicy', type=d.T.string)]),
          withFailurePolicy(failurePolicy): { spec+: { strategy+: { rollingParams+: { pre+: { failurePolicy: failurePolicy } } } } },
          '#withTagImages':: d.fn(help='"TagImages instructs the deployer to tag the current image referenced under a container onto an image stream tag."', args=[d.arg(name='tagImages', type=d.T.array)]),
          withTagImages(tagImages): { spec+: { strategy+: { rollingParams+: { pre+: { tagImages: if std.isArray(v=tagImages) then tagImages else [tagImages] } } } } },
          '#withTagImagesMixin':: d.fn(help='"TagImages instructs the deployer to tag the current image referenced under a container onto an image stream tag."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tagImages', type=d.T.array)]),
          withTagImagesMixin(tagImages): { spec+: { strategy+: { rollingParams+: { pre+: { tagImages+: if std.isArray(v=tagImages) then tagImages else [tagImages] } } } } },
        },
        ...
        withIntervalSeconds(intervalSeconds): { spec+: { strategy+: { rollingParams+: { intervalSeconds: intervalSeconds } } } },
        '#withMaxSurge':: d.fn(help='', args=[d.arg(name='maxSurge', type=d.T.string)]),
        withMaxSurge(maxSurge): { spec+: { strategy+: { rollingParams+: { maxSurge: maxSurge } } } },
        '#withMaxUnavailable':: d.fn(help='', args=[d.arg(name='maxUnavailable', type=d.T.string)]),
        withMaxUnavailable(maxUnavailable): { spec+: { strategy+: { rollingParams+: { maxUnavailable: maxUnavailable } } } },
        '#withTimeoutSeconds':: d.fn(help='"TimeoutSeconds is the time to wait for updates before giving up. If the value is nil, a default will be used."', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
        withTimeoutSeconds(timeoutSeconds): { spec+: { strategy+: { rollingParams+: { timeoutSeconds: timeoutSeconds } } } },
        ...
        withUpdatePeriodSeconds(updatePeriodSeconds): { spec+: { strategy+: { rollingParams+: { updatePeriodSeconds: updatePeriodSeconds } } } },
      },
      ...
      withActiveDeadlineSeconds(activeDeadlineSeconds): { spec+: { strategy+: { activeDeadlineSeconds: activeDeadlineSeconds } } },
      ...
      withAnnotations(annotations): { spec+: { strategy+: { annotations: annotations } } },
      ...
      withAnnotationsMixin(annotations): { spec+: { strategy+: { annotations+: annotations } } },
      ...
      metadata: {
        ...
        initializers: {
          ...
          result: {
            ...
            '#withApiVersion':: d.fn(help='"APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#resources"', args=[d.arg(name='apiVersion', type=d.T.string)]),
            withApiVersion(apiVersion): { spec+: { template+: { metadata+: { initializers+: { result+: { apiVersion: apiVersion } } } } } },
            '#withCode':: d.fn(help='"Suggested HTTP return code for this status, 0 if not set."', args=[d.arg(name='code', type=d.T.integer)]),
