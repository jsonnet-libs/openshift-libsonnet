{
  ...
  '#new':: d.fn(help='new returns an instance of BuildConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'build.openshift.io/v1',
    kind: 'BuildConfig',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"BuildConfigSpec describes when and how builds are created"'),
  spec: {
    '#output':: d.obj(help='"BuildOutput is input to a build strategy and describes the container image that the strategy should produce."'),
    output: {
    ...
    postCommit: {
      '#withArgs':: d.fn(help="\"args is a list of arguments that are provided to either Command, Script or the container image's default entrypoint. The arguments are placed immediately after the command to be run.\"", args=[d.arg(name='args', type=d.T.array)]),
      withArgs(args): { spec+: { postCommit+: { args: if std.isArray(v=args) then args else [args] } } },
      '#withArgsMixin':: d.fn(help="\"args is a list of arguments that are provided to either Command, Script or the container image's default entrypoint. The arguments are placed immediately after the command to be run.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='args', type=d.T.array)]),
    ...
    withFailedBuildsHistoryLimit(failedBuildsHistoryLimit): { spec+: { failedBuildsHistoryLimit: failedBuildsHistoryLimit } },
    ...
    withRunPolicy(runPolicy): { spec+: { runPolicy: runPolicy } },
    ...
    withSuccessfulBuildsHistoryLimit(successfulBuildsHistoryLimit): { spec+: { successfulBuildsHistoryLimit: successfulBuildsHistoryLimit } },
