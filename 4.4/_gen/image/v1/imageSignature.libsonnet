{
  ...
  '#':: d.pkg(name='imageSignature', url='', help="\"ImageSignature holds a signature of an image. It allows to verify image identity and possibly other claims as long as the signature is trusted. Based on this information it is possible to restrict runnable images to those matching cluster-wide policy. Mandatory fields should be parsed by clients doing image verification. The others are parsed from signature's content by the server. They serve just an informative purpose.\""),
  '#issuedBy':: d.obj(help='"SignatureIssuer holds information about an issuer of signing certificate or key."'),
  issuedBy: {
    '#withCommonName':: d.fn(help='"Common name (e.g. openshift-signing-service)."', args=[d.arg(name='commonName', type=d.T.string)]),
    withCommonName(commonName): { issuedBy+: { commonName: commonName } },
    '#withOrganization':: d.fn(help='"Organization name."', args=[d.arg(name='organization', type=d.T.string)]),
    withOrganization(organization): { issuedBy+: { organization: organization } },
  },
  '#issuedTo':: d.obj(help='"SignatureSubject holds information about a person or entity who created the signature."'),
  issuedTo: {
    '#withCommonName':: d.fn(help='"Common name (e.g. openshift-signing-service)."', args=[d.arg(name='commonName', type=d.T.string)]),
    withCommonName(commonName): { issuedTo+: { commonName: commonName } },
    '#withOrganization':: d.fn(help='"Organization name."', args=[d.arg(name='organization', type=d.T.string)]),
    withOrganization(organization): { issuedTo+: { organization: organization } },
    ...
    withPublicKeyID(publicKeyID): { issuedTo+: { publicKeyID: publicKeyID } },
  },
  ...
  '#new':: d.fn(help='new returns an instance of ImageSignature', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'image.openshift.io/v1',
    kind: 'ImageSignature',
  } + self.metadata.withName(name=name),
  '#withConditions':: d.fn(help="\"Conditions represent the latest available observations of a signature's current state.\"", args=[d.arg(name='conditions', type=d.T.array)]),
  withConditions(conditions): { conditions: if std.isArray(v=conditions) then conditions else [conditions] },
  '#withConditionsMixin':: d.fn(help="\"Conditions represent the latest available observations of a signature's current state.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='conditions', type=d.T.array)]),
  withConditionsMixin(conditions): { conditions+: if std.isArray(v=conditions) then conditions else [conditions] },
  '#withContent':: d.fn(help="\"Required: An opaque binary string which is an image's signature.\"", args=[d.arg(name='content', type=d.T.string)]),
  ...
  '#withImageIdentity':: d.fn(help="\"A human readable string representing image's identity. It could be a product name and version, or an image pull spec (e.g. \\\"registry.access.redhat.com/rhel7/rhel:7.2\\\").\"", args=[d.arg(name='imageIdentity', type=d.T.string)]),
  withImageIdentity(imageIdentity): { imageIdentity: imageIdentity },
  '#withSignedClaims':: d.fn(help='"Contains claims from the signature."', args=[d.arg(name='signedClaims', type=d.T.object)]),
  withSignedClaims(signedClaims): { signedClaims: signedClaims },
  '#withSignedClaimsMixin':: d.fn(help='"Contains claims from the signature."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='signedClaims', type=d.T.object)]),
  withSignedClaimsMixin(signedClaims): { signedClaims+: signedClaims },
  '#withType':: d.fn(help='"Required: Describes a type of stored blob."', args=[d.arg(name='type', type=d.T.string)]),
