{
  ...
  '#':: d.pkg(name='clusterNetwork', url='', help='"ClusterNetwork describes the cluster network. There is normally only one object of this type, named \\"default\\", which is created by the SDN network plugin based on the master configuration when the cluster is brought up for the first time."'),
  ...
  '#new':: d.fn(help='new returns an instance of ClusterNetwork', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'network.openshift.io/v1',
    kind: 'ClusterNetwork',
  } + self.metadata.withName(name=name),
  '#withClusterNetworks':: d.fn(help="\"ClusterNetworks is a list of ClusterNetwork objects that defines the global overlay network's L3 space by specifying a set of CIDR and netmasks that the SDN can allocate addressed from.\"", args=[d.arg(name='clusterNetworks', type=d.T.array)]),
  withClusterNetworks(clusterNetworks): { clusterNetworks: if std.isArray(v=clusterNetworks) then clusterNetworks else [clusterNetworks] },
  '#withClusterNetworksMixin':: d.fn(help="\"ClusterNetworks is a list of ClusterNetwork objects that defines the global overlay network's L3 space by specifying a set of CIDR and netmasks that the SDN can allocate addressed from.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='clusterNetworks', type=d.T.array)]),
  withClusterNetworksMixin(clusterNetworks): { clusterNetworks+: if std.isArray(v=clusterNetworks) then clusterNetworks else [clusterNetworks] },
  '#withHostsubnetlength':: d.fn(help='"HostSubnetLength is the number of bits of network to allocate to each node. eg, 8 would mean that each node would have a /24 slice of the overlay network for its pods"', args=[d.arg(name='hostsubnetlength', type=d.T.integer)]),
  withHostsubnetlength(hostsubnetlength): { hostsubnetlength: hostsubnetlength },
  '#withNetwork':: d.fn(help="\"Network is a CIDR string specifying the global overlay network's L3 space\"", args=[d.arg(name='network', type=d.T.string)]),
  withNetwork(network): { network: network },
  '#withPluginName':: d.fn(help='"PluginName is the name of the network plugin being used"', args=[d.arg(name='pluginName', type=d.T.string)]),
  withPluginName(pluginName): { pluginName: pluginName },
  '#withServiceNetwork':: d.fn(help='"ServiceNetwork is the CIDR range that Service IP addresses are allocated from"', args=[d.arg(name='serviceNetwork', type=d.T.string)]),
  withServiceNetwork(serviceNetwork): { serviceNetwork: serviceNetwork },
  '#withVxlanPort':: d.fn(help='"VXLANPort sets the VXLAN destination port used by the cluster. It is set by the master configuration file on startup and cannot be edited manually. Valid values for VXLANPort are integers 1-65535 inclusive and if unset defaults to 4789. Changing VXLANPort allows users to resolve issues between openshift SDN and other software trying to use the same VXLAN destination port."', args=[d.arg(name='vxlanPort', type=d.T.integer)]),
  withVxlanPort(vxlanPort): { vxlanPort: vxlanPort },
  '#mixin': 'ignore',
  mixin: self,
}
