{
  ...
  '#':: d.pkg(name='appliedClusterResourceQuota', url='', help='"AppliedClusterResourceQuota mirrors ClusterResourceQuota at a project scope, for projection into a project.  It allows a project-admin to know which ClusterResourceQuotas are applied to his project and their associated usage."'),
  ...
  '#new':: d.fn(help='new returns an instance of AppliedClusterResourceQuota', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'quota.openshift.io/v1',
    kind: 'AppliedClusterResourceQuota',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ClusterResourceQuotaSpec defines the desired quota restrictions"'),
  spec: {
    ...
    quota: {
      ...
      scopeSelector: {
        ...
        withMatchExpressions(matchExpressions): { spec+: { quota+: { scopeSelector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchExpressionsMixin':: d.fn(help='"A list of scope selector requirements by scope of the resources."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressionsMixin(matchExpressions): { spec+: { quota+: { scopeSelector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
      },
      ...
      withHard(hard): { spec+: { quota+: { hard: hard } } },
      ...
      withHardMixin(hard): { spec+: { quota+: { hard+: hard } } },
      ...
      withScopes(scopes): { spec+: { quota+: { scopes: if std.isArray(v=scopes) then scopes else [scopes] } } },
      ...
      withScopesMixin(scopes): { spec+: { quota+: { scopes+: if std.isArray(v=scopes) then scopes else [scopes] } } },
    },
    ...
    selector: {
      ...
      labels: {
        ...
        withMatchExpressions(matchExpressions): { spec+: { selector+: { labels+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
        withMatchExpressionsMixin(matchExpressions): { spec+: { selector+: { labels+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } },
        '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
        withMatchLabels(matchLabels): { spec+: { selector+: { labels+: { matchLabels: matchLabels } } } },
        ...
        withMatchLabelsMixin(matchLabels): { spec+: { selector+: { labels+: { matchLabels+: matchLabels } } } },
      },
      ...
      withAnnotations(annotations): { spec+: { selector+: { annotations: annotations } } },
      '#withAnnotationsMixin':: d.fn(help='"AnnotationSelector is used to select projects by annotation."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
      withAnnotationsMixin(annotations): { spec+: { selector+: { annotations+: annotations } } },
    },
  },
  '#mixin': 'ignore',
  mixin: self,
