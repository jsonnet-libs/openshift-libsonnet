{
  ...
  '#':: d.pkg(name='localResourceAccessReview', url='', help='"LocalResourceAccessReview is a means to request a list of which users and groups are authorized to perform the action specified by spec in a particular namespace"'),
  ...
  '#new':: d.fn(help='new returns an instance of LocalResourceAccessReview', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
