{
  ...
  '#':: d.pkg(name='projectRequest', url='', help='"ProjecRequest is the set of options necessary to fully qualify a project request"'),
  ...
  '#new':: d.fn(help='new returns an instance of ProjectRequest', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'project.openshift.io/v1',
    kind: 'ProjectRequest',
  } + self.metadata.withName(name=name),
  '#withDescription':: d.fn(help='"Description is the description to apply to a project"', args=[d.arg(name='description', type=d.T.string)]),
  withDescription(description): { description: description },
  '#withDisplayName':: d.fn(help='"DisplayName is the display name to apply to a project"', args=[d.arg(name='displayName', type=d.T.string)]),
