{
  ...
  '#':: d.pkg(name='oAuthAuthorizeToken', url='', help='"OAuthAuthorizeToken describes an OAuth authorization token"'),
  ...
  '#new':: d.fn(help='new returns an instance of OAuthAuthorizeToken', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#withCodeChallenge':: d.fn(help='"CodeChallenge is the optional code_challenge associated with this authorization code, as described in rfc7636"', args=[d.arg(name='codeChallenge', type=d.T.string)]),
  withCodeChallenge(codeChallenge): { codeChallenge: codeChallenge },
  '#withCodeChallengeMethod':: d.fn(help='"CodeChallengeMethod is the optional code_challenge_method associated with this authorization code, as described in rfc7636"', args=[d.arg(name='codeChallengeMethod', type=d.T.string)]),
  withCodeChallengeMethod(codeChallengeMethod): { codeChallengeMethod: codeChallengeMethod },
  ...
  '#withState':: d.fn(help='"State data from request"', args=[d.arg(name='state', type=d.T.string)]),
  ...
  '#withUserUID':: d.fn(help='"UserUID is the unique UID associated with this token. UserUID and UserName must both match for this token to be valid."', args=[d.arg(name='userUID', type=d.T.string)]),
