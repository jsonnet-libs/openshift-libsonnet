{
  ...
  '#':: d.pkg(name='oAuthClient', url='', help='"OAuthClient describes an OAuth client"'),
  ...
  '#new':: d.fn(help='new returns an instance of OAuthClient', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'oauth.openshift.io/v1',
    kind: 'OAuthClient',
  } + self.metadata.withName(name=name),
  '#withAccessTokenInactivityTimeoutSeconds':: d.fn(help='"AccessTokenInactivityTimeoutSeconds overrides the default token inactivity timeout for tokens granted to this client. The value represents the maximum amount of time that can occur between consecutive uses of the token. Tokens become invalid if they are not used within this temporal window. The user will need to acquire a new token to regain access once a token times out. This value needs to be set only if the default set in configuration is not appropriate for this client. Valid values are: - 0: Tokens for this client never time out - X: Tokens time out if there is no activity for X seconds The current minimum allowed value for X is 300 (5 minutes)"', args=[d.arg(name='accessTokenInactivityTimeoutSeconds', type=d.T.integer)]),
  withAccessTokenInactivityTimeoutSeconds(accessTokenInactivityTimeoutSeconds): { accessTokenInactivityTimeoutSeconds: accessTokenInactivityTimeoutSeconds },
  '#withAccessTokenMaxAgeSeconds':: d.fn(help='"AccessTokenMaxAgeSeconds overrides the default access token max age for tokens granted to this client. 0 means no expiration."', args=[d.arg(name='accessTokenMaxAgeSeconds', type=d.T.integer)]),
  withAccessTokenMaxAgeSeconds(accessTokenMaxAgeSeconds): { accessTokenMaxAgeSeconds: accessTokenMaxAgeSeconds },
  '#withAdditionalSecrets':: d.fn(help='"AdditionalSecrets holds other secrets that may be used to identify the client.  This is useful for rotation and for service account token validation"', args=[d.arg(name='additionalSecrets', type=d.T.array)]),
  withAdditionalSecrets(additionalSecrets): { additionalSecrets: if std.isArray(v=additionalSecrets) then additionalSecrets else [additionalSecrets] },
  '#withAdditionalSecretsMixin':: d.fn(help='"AdditionalSecrets holds other secrets that may be used to identify the client.  This is useful for rotation and for service account token validation"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='additionalSecrets', type=d.T.array)]),
  withAdditionalSecretsMixin(additionalSecrets): { additionalSecrets+: if std.isArray(v=additionalSecrets) then additionalSecrets else [additionalSecrets] },
  '#withGrantMethod':: d.fn(help='"GrantMethod determines how to handle grants for this client. If no method is provided, the cluster default grant handling method will be used. Valid grant handling methods are:\\n - auto:   always approves grant requests, useful for trusted clients\\n - prompt: prompts the end user for approval of grant requests, useful for third-party clients\\n - deny:   always denies grant requests, useful for black-listed clients"', args=[d.arg(name='grantMethod', type=d.T.string)]),
  withGrantMethod(grantMethod): { grantMethod: grantMethod },
  '#withRedirectURIs':: d.fn(help='"RedirectURIs is the valid redirection URIs associated with a client"', args=[d.arg(name='redirectURIs', type=d.T.array)]),
  withRedirectURIs(redirectURIs): { redirectURIs: if std.isArray(v=redirectURIs) then redirectURIs else [redirectURIs] },
  '#withRedirectURIsMixin':: d.fn(help='"RedirectURIs is the valid redirection URIs associated with a client"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='redirectURIs', type=d.T.array)]),
  withRedirectURIsMixin(redirectURIs): { redirectURIs+: if std.isArray(v=redirectURIs) then redirectURIs else [redirectURIs] },
  '#withRespondWithChallenges':: d.fn(help='"RespondWithChallenges indicates whether the client wants authentication needed responses made in the form of challenges instead of redirects"', args=[d.arg(name='respondWithChallenges', type=d.T.boolean)]),
  withRespondWithChallenges(respondWithChallenges): { respondWithChallenges: respondWithChallenges },
  '#withScopeRestrictions':: d.fn(help='"ScopeRestrictions describes which scopes this client can request.  Each requested scope is checked against each restriction.  If any restriction matches, then the scope is allowed. If no restriction matches, then the scope is denied."', args=[d.arg(name='scopeRestrictions', type=d.T.array)]),
  withScopeRestrictions(scopeRestrictions): { scopeRestrictions: if std.isArray(v=scopeRestrictions) then scopeRestrictions else [scopeRestrictions] },
  '#withScopeRestrictionsMixin':: d.fn(help='"ScopeRestrictions describes which scopes this client can request.  Each requested scope is checked against each restriction.  If any restriction matches, then the scope is allowed. If no restriction matches, then the scope is denied."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopeRestrictions', type=d.T.array)]),
  withScopeRestrictionsMixin(scopeRestrictions): { scopeRestrictions+: if std.isArray(v=scopeRestrictions) then scopeRestrictions else [scopeRestrictions] },
  '#withSecret':: d.fn(help='"Secret is the unique secret associated with a client"', args=[d.arg(name='secret', type=d.T.string)]),
