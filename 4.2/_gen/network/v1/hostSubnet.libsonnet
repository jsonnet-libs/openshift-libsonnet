{
  ...
  '#':: d.pkg(name='hostSubnet', url='', help='"HostSubnet describes the container subnet network on a node. The HostSubnet object must have the same name as the Node object it corresponds to."'),
  ...
  '#new':: d.fn(help='new returns an instance of HostSubnet', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'network.openshift.io/v1',
    kind: 'HostSubnet',
  } + self.metadata.withName(name=name),
  '#withEgressCIDRs':: d.fn(help='"EgressCIDRs is the list of CIDR ranges available for automatically assigning egress IPs to this node from. If this field is set then EgressIPs should be treated as read-only."', args=[d.arg(name='egressCIDRs', type=d.T.array)]),
  withEgressCIDRs(egressCIDRs): { egressCIDRs: if std.isArray(v=egressCIDRs) then egressCIDRs else [egressCIDRs] },
  '#withEgressCIDRsMixin':: d.fn(help='"EgressCIDRs is the list of CIDR ranges available for automatically assigning egress IPs to this node from. If this field is set then EgressIPs should be treated as read-only."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='egressCIDRs', type=d.T.array)]),
  withEgressCIDRsMixin(egressCIDRs): { egressCIDRs+: if std.isArray(v=egressCIDRs) then egressCIDRs else [egressCIDRs] },
  '#withEgressIPs':: d.fn(help='"EgressIPs is the list of automatic egress IP addresses currently hosted by this node. If EgressCIDRs is empty, this can be set by hand; if EgressCIDRs is set then the master will overwrite the value here with its own allocation of egress IPs."', args=[d.arg(name='egressIPs', type=d.T.array)]),
  withEgressIPs(egressIPs): { egressIPs: if std.isArray(v=egressIPs) then egressIPs else [egressIPs] },
  '#withEgressIPsMixin':: d.fn(help='"EgressIPs is the list of automatic egress IP addresses currently hosted by this node. If EgressCIDRs is empty, this can be set by hand; if EgressCIDRs is set then the master will overwrite the value here with its own allocation of egress IPs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='egressIPs', type=d.T.array)]),
  withEgressIPsMixin(egressIPs): { egressIPs+: if std.isArray(v=egressIPs) then egressIPs else [egressIPs] },
  '#withHost':: d.fn(help="\"Host is the name of the node. (This is the same as the object's name, but both fields must be set.)\"", args=[d.arg(name='host', type=d.T.string)]),
  withHost(host): { host: host },
  '#withHostIP':: d.fn(help='"HostIP is the IP address to be used as a VTEP by other nodes in the overlay network"', args=[d.arg(name='hostIP', type=d.T.string)]),
  withHostIP(hostIP): { hostIP: hostIP },
  '#withSubnet':: d.fn(help='"Subnet is the CIDR range of the overlay network assigned to the node for its pods"', args=[d.arg(name='subnet', type=d.T.string)]),
