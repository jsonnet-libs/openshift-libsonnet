{
  ...
  '#':: d.pkg(name='imageStreamImage', url='', help='"ImageStreamImage represents an Image that is retrieved by image name from an ImageStream."'),
  ...
  '#new':: d.fn(help='new returns an instance of ImageStreamImage', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
