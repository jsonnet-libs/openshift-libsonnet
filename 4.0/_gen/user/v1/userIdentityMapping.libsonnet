{
  ...
  '#':: d.pkg(name='userIdentityMapping', url='', help='"UserIdentityMapping maps a user to an identity"'),
  '#identity':: d.obj(help='"ObjectReference contains enough information to let you inspect or modify the referred object."'),
  identity: {
    '#withApiVersion':: d.fn(help='"API version of the referent."', args=[d.arg(name='apiVersion', type=d.T.string)]),
    withApiVersion(apiVersion): { identity+: { apiVersion: apiVersion } },
    ...
    withFieldPath(fieldPath): { identity+: { fieldPath: fieldPath } },
    ...
    withKind(kind): { identity+: { kind: kind } },
    '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
    withName(name): { identity+: { name: name } },
    ...
    withNamespace(namespace): { identity+: { namespace: namespace } },
    ...
    withResourceVersion(resourceVersion): { identity+: { resourceVersion: resourceVersion } },
  ...
  '#new':: d.fn(help='new returns an instance of UserIdentityMapping', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
