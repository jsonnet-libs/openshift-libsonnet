{
  ...
  '#':: d.pkg(name='deploymentCauseImageTrigger', url='', help='"DeploymentCauseImageTrigger represents details about the cause of a deployment originating from an image change trigger"'),
