{
  ...
  '#':: d.pkg(name='deploymentTriggerPolicy', url='', help='"DeploymentTriggerPolicy describes a policy for a single trigger that results in a new deployment."'),
  '#imageChangeParams':: d.obj(help='"DeploymentTriggerImageChangeParams represents the parameters to the ImageChange trigger."'),
  imageChangeParams: {
    ...
    from: {
      ...
      withApiVersion(apiVersion): { imageChangeParams+: { from+: { apiVersion: apiVersion } } },
      ...
      withFieldPath(fieldPath): { imageChangeParams+: { from+: { fieldPath: fieldPath } } },
      ...
      withKind(kind): { imageChangeParams+: { from+: { kind: kind } } },
      '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { imageChangeParams+: { from+: { name: name } } },
      ...
      withNamespace(namespace): { imageChangeParams+: { from+: { namespace: namespace } } },
      ...
      withResourceVersion(resourceVersion): { imageChangeParams+: { from+: { resourceVersion: resourceVersion } } },
      ...
      withUid(uid): { imageChangeParams+: { from+: { uid: uid } } },
    },
    ...
    withAutomatic(automatic): { imageChangeParams+: { automatic: automatic } },
    ...
    withContainerNames(containerNames): { imageChangeParams+: { containerNames: if std.isArray(v=containerNames) then containerNames else [containerNames] } },
    ...
    withContainerNamesMixin(containerNames): { imageChangeParams+: { containerNames+: if std.isArray(v=containerNames) then containerNames else [containerNames] } },
    ...
    withLastTriggeredImage(lastTriggeredImage): { imageChangeParams+: { lastTriggeredImage: lastTriggeredImage } },
  },
  '#withType':: d.fn(help='"Type of the trigger"', args=[d.arg(name='type', type=d.T.string)]),
