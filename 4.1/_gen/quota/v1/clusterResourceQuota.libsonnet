{
  ...
  '#':: d.pkg(name='clusterResourceQuota', url='', help='"ClusterResourceQuota mirrors ResourceQuota at a cluster scope.  This object is easily convertible to synthetic ResourceQuota object to allow quota evaluation re-use."'),
  ...
  '#new':: d.fn(help='new returns an instance of ClusterResourceQuota', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
