{
  ...
  '#':: d.pkg(name='templateInstance', url='', help='"TemplateInstance requests and records the instantiation of a Template. TemplateInstance is part of an experimental API."'),
  ...
  '#new':: d.fn(help='new returns an instance of TemplateInstance', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'template.openshift.io/v1',
    kind: 'TemplateInstance',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"TemplateInstanceSpec describes the desired state of a TemplateInstance."'),
  spec: {
    ...
    requester: {
      ...
      withExtra(extra): { spec+: { requester+: { extra: extra } } },
      ...
      withExtraMixin(extra): { spec+: { requester+: { extra+: extra } } },
      '#withGroups':: d.fn(help='"groups represent the groups this user is a part of."', args=[d.arg(name='groups', type=d.T.array)]),
      withGroups(groups): { spec+: { requester+: { groups: if std.isArray(v=groups) then groups else [groups] } } },
      ...
      withGroupsMixin(groups): { spec+: { requester+: { groups+: if std.isArray(v=groups) then groups else [groups] } } },
      ...
      withUid(uid): { spec+: { requester+: { uid: uid } } },
      ...
      withUsername(username): { spec+: { requester+: { username: username } } },
    },
    ...
    template: {
      ...
      '#withApiVersion':: d.fn(help='"APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#resources"', args=[d.arg(name='apiVersion', type=d.T.string)]),
      withApiVersion(apiVersion): { spec+: { template+: { apiVersion: apiVersion } } },
      '#withKind':: d.fn(help='"Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds"', args=[d.arg(name='kind', type=d.T.string)]),
      withKind(kind): { spec+: { template+: { kind: kind } } },
      ...
      withMessage(message): { spec+: { template+: { message: message } } },
      ...
      withObjects(objects): { spec+: { template+: { objects: if std.isArray(v=objects) then objects else [objects] } } },
      ...
      withObjectsMixin(objects): { spec+: { template+: { objects+: if std.isArray(v=objects) then objects else [objects] } } },
      ...
      withParameters(parameters): { spec+: { template+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } } },
      ...
      withParametersMixin(parameters): { spec+: { template+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } } },
    },
  },
  '#mixin': 'ignore',
  mixin: self,
