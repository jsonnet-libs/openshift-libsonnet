{
  ...
  '#':: d.pkg(name='rangeAllocation', url='', help='"RangeAllocation is used so we can easily expose a RangeAllocation typed for security group"'),
  ...
  '#new':: d.fn(help='new returns an instance of RangeAllocation', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'security.openshift.io/v1',
    kind: 'RangeAllocation',
  } + self.metadata.withName(name=name),
  '#withData':: d.fn(help='"data is a byte array representing the serialized state of a range allocation.  It is a bitmap with each bit set to one to represent a range is taken."', args=[d.arg(name='data', type=d.T.string)]),
  withData(data): { data: data },
  '#withRange':: d.fn(help='"range is a string representing a unique label for a range of uids, \\"1000000000-2000000000/10000\\"."', args=[d.arg(name='range', type=d.T.string)]),
