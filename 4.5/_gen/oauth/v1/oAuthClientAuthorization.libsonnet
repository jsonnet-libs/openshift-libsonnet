{
  ...
  '#':: d.pkg(name='oAuthClientAuthorization', url='', help='"OAuthClientAuthorization describes an authorization created by an OAuth client"'),
  ...
  '#new':: d.fn(help='new returns an instance of OAuthClientAuthorization', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'oauth.openshift.io/v1',
    kind: 'OAuthClientAuthorization',
  } + self.metadata.withName(name=name),
  '#withClientName':: d.fn(help='"ClientName references the client that created this authorization"', args=[d.arg(name='clientName', type=d.T.string)]),
  withClientName(clientName): { clientName: clientName },
  '#withScopes':: d.fn(help='"Scopes is an array of the granted scopes."', args=[d.arg(name='scopes', type=d.T.array)]),
  withScopes(scopes): { scopes: if std.isArray(v=scopes) then scopes else [scopes] },
  '#withScopesMixin':: d.fn(help='"Scopes is an array of the granted scopes."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopes', type=d.T.array)]),
  withScopesMixin(scopes): { scopes+: if std.isArray(v=scopes) then scopes else [scopes] },
  '#withUserName':: d.fn(help='"UserName is the user name that authorized this client"', args=[d.arg(name='userName', type=d.T.string)]),
  withUserName(userName): { userName: userName },
  '#withUserUID':: d.fn(help='"UserUID is the unique UID associated with this authorization. UserUID and UserName must both match for this authorization to be valid."', args=[d.arg(name='userUID', type=d.T.string)]),
