{
  ...
  '#':: d.pkg(name='oAuthAccessToken', url='', help='"OAuthAccessToken describes an OAuth access token"'),
  ...
  '#new':: d.fn(help='new returns an instance of OAuthAccessToken', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'oauth.openshift.io/v1',
    kind: 'OAuthAccessToken',
  } + self.metadata.withName(name=name),
  '#withAuthorizeToken':: d.fn(help='"AuthorizeToken contains the token that authorized this token"', args=[d.arg(name='authorizeToken', type=d.T.string)]),
  withAuthorizeToken(authorizeToken): { authorizeToken: authorizeToken },
  '#withClientName':: d.fn(help='"ClientName references the client that created this token."', args=[d.arg(name='clientName', type=d.T.string)]),
  withClientName(clientName): { clientName: clientName },
  '#withExpiresIn':: d.fn(help='"ExpiresIn is the seconds from CreationTime before this token expires."', args=[d.arg(name='expiresIn', type=d.T.integer)]),
  withExpiresIn(expiresIn): { expiresIn: expiresIn },
  '#withInactivityTimeoutSeconds':: d.fn(help='"InactivityTimeoutSeconds is the value in seconds, from the CreationTimestamp, after which this token can no longer be used. The value is automatically incremented when the token is used."', args=[d.arg(name='inactivityTimeoutSeconds', type=d.T.integer)]),
  withInactivityTimeoutSeconds(inactivityTimeoutSeconds): { inactivityTimeoutSeconds: inactivityTimeoutSeconds },
  '#withRedirectURI':: d.fn(help='"RedirectURI is the redirection associated with the token."', args=[d.arg(name='redirectURI', type=d.T.string)]),
  withRedirectURI(redirectURI): { redirectURI: redirectURI },
  '#withRefreshToken':: d.fn(help='"RefreshToken is the value by which this token can be renewed. Can be blank."', args=[d.arg(name='refreshToken', type=d.T.string)]),
  withRefreshToken(refreshToken): { refreshToken: refreshToken },
  '#withScopes':: d.fn(help='"Scopes is an array of the requested scopes."', args=[d.arg(name='scopes', type=d.T.array)]),
  withScopes(scopes): { scopes: if std.isArray(v=scopes) then scopes else [scopes] },
  '#withScopesMixin':: d.fn(help='"Scopes is an array of the requested scopes."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopes', type=d.T.array)]),
  withScopesMixin(scopes): { scopes+: if std.isArray(v=scopes) then scopes else [scopes] },
  '#withUserName':: d.fn(help='"UserName is the user name associated with this token"', args=[d.arg(name='userName', type=d.T.string)]),
  withUserName(userName): { userName: userName },
  '#withUserUID':: d.fn(help='"UserUID is the unique UID associated with this token"', args=[d.arg(name='userUID', type=d.T.string)]),
  withUserUID(userUID): { userUID: userUID },
  '#mixin': 'ignore',
  mixin: self,
}
