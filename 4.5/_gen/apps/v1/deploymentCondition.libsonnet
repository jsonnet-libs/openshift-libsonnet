{
  ...
  '#':: d.pkg(name='deploymentCondition', url='', help='"DeploymentCondition describes the state of a deployment config at a certain point."'),
  ...
  '#withLastUpdateTime':: d.fn(help='', args=[d.arg(name='lastUpdateTime', type=d.T.string)]),
