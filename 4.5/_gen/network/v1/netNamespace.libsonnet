{
  ...
  '#':: d.pkg(name='netNamespace', url='', help='"NetNamespace describes a single isolated network. When using the redhat/openshift-ovs-multitenant plugin, every Namespace will have a corresponding NetNamespace object with the same name. (When using redhat/openshift-ovs-subnet, NetNamespaces are not used.)"'),
  ...
  '#new':: d.fn(help='new returns an instance of NetNamespace', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'network.openshift.io/v1',
    kind: 'NetNamespace',
  } + self.metadata.withName(name=name),
  '#withEgressIPs':: d.fn(help='"EgressIPs is a list of reserved IPs that will be used as the source for external traffic coming from pods in this namespace. (If empty, external traffic will be masqueraded to Node IPs.)"', args=[d.arg(name='egressIPs', type=d.T.array)]),
  withEgressIPs(egressIPs): { egressIPs: if std.isArray(v=egressIPs) then egressIPs else [egressIPs] },
  '#withEgressIPsMixin':: d.fn(help='"EgressIPs is a list of reserved IPs that will be used as the source for external traffic coming from pods in this namespace. (If empty, external traffic will be masqueraded to Node IPs.)"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='egressIPs', type=d.T.array)]),
  withEgressIPsMixin(egressIPs): { egressIPs+: if std.isArray(v=egressIPs) then egressIPs else [egressIPs] },
  '#withNetid':: d.fn(help='"NetID is the network identifier of the network namespace assigned to each overlay network packet. This can be manipulated with the \\"oc adm pod-network\\" commands."', args=[d.arg(name='netid', type=d.T.integer)]),
  withNetid(netid): { netid: netid },
  '#withNetname':: d.fn(help="\"NetName is the name of the network namespace. (This is the same as the object's name, but both fields must be set.)\"", args=[d.arg(name='netname', type=d.T.string)]),
  withNetname(netname): { netname: netname },
  '#mixin': 'ignore',
  mixin: self,
}
