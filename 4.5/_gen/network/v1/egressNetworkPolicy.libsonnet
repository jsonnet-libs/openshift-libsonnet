{
  ...
  '#new':: d.fn(help='new returns an instance of EgressNetworkPolicy', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'network.openshift.io/v1',
    kind: 'EgressNetworkPolicy',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"EgressNetworkPolicySpec provides a list of policies on outgoing network traffic"'),
  spec: {
