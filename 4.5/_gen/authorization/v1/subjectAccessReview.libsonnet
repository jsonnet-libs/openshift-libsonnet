{
  ...
  '#':: d.pkg(name='subjectAccessReview', url='', help='"SubjectAccessReview is an object for requesting information about whether a user or group can perform an action"'),
  ...
  '#withGroups':: d.fn(help='"GroupsSlice is optional. Groups is the list of groups to which the User belongs."', args=[d.arg(name='groups', type=d.T.array)]),
  withGroups(groups): { groups: if std.isArray(v=groups) then groups else [groups] },
  '#withGroupsMixin':: d.fn(help='"GroupsSlice is optional. Groups is the list of groups to which the User belongs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='groups', type=d.T.array)]),
