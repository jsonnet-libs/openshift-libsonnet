{
  ...
  '#':: d.pkg(name='group', url='', help='"Group represents a referenceable set of Users"'),
  ...
  '#withUsers':: d.fn(help='"Users is the list of users in this group."', args=[d.arg(name='users', type=d.T.array)]),
  withUsers(users): { users: if std.isArray(v=users) then users else [users] },
  '#withUsersMixin':: d.fn(help='"Users is the list of users in this group."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='users', type=d.T.array)]),
