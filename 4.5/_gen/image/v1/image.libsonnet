{
  ...
  '#':: d.pkg(name='image', url='', help='"Image is an immutable representation of a container image and metadata at a point in time."'),
  ...
  dockerImageMetadata: {
    ...
    withRaw(raw): { dockerImageMetadata+: { raw: raw } },
  },
  ...
  withDockerImageConfig(dockerImageConfig): { dockerImageConfig: dockerImageConfig },
  ...
  withDockerImageLayers(dockerImageLayers): { dockerImageLayers: if std.isArray(v=dockerImageLayers) then dockerImageLayers else [dockerImageLayers] },
  ...
  withDockerImageLayersMixin(dockerImageLayers): { dockerImageLayers+: if std.isArray(v=dockerImageLayers) then dockerImageLayers else [dockerImageLayers] },
  ...
  withDockerImageManifest(dockerImageManifest): { dockerImageManifest: dockerImageManifest },
  ...
  withDockerImageManifestMediaType(dockerImageManifestMediaType): { dockerImageManifestMediaType: dockerImageManifestMediaType },
  ...
  withDockerImageMetadataVersion(dockerImageMetadataVersion): { dockerImageMetadataVersion: dockerImageMetadataVersion },
  ...
  withDockerImageSignatures(dockerImageSignatures): { dockerImageSignatures: if std.isArray(v=dockerImageSignatures) then dockerImageSignatures else [dockerImageSignatures] },
  ...
  withDockerImageSignaturesMixin(dockerImageSignatures): { dockerImageSignatures+: if std.isArray(v=dockerImageSignatures) then dockerImageSignatures else [dockerImageSignatures] },
  '#withSignatures':: d.fn(help='"Signatures holds all signatures of the image."', args=[d.arg(name='signatures', type=d.T.array)]),
  withSignatures(signatures): { signatures: if std.isArray(v=signatures) then signatures else [signatures] },
  ...
  withSignaturesMixin(signatures): { signatures+: if std.isArray(v=signatures) then signatures else [signatures] },
  '#mixin': 'ignore',
  mixin: self,
}
